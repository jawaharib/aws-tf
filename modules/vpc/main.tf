...
resource "aws_vpc" "this" {
  ...
  tags = merge(
    {
      "Name" = format("%s-%s-vpc", var.app_name, var.env)
    },
    local.tags,
    var.vpc_tags
  )
...
resource "aws_default_security_group" "this" {
  ...
  tags = merge(
    {
      "Name" = format("%s-%s-%s-sg", var.app_name, var.env, var.default_security_group_name)
    },
    local.tags,
...
resource "aws_vpc_dhcp_options" "this" {
  ...
  tags = merge(
    {
      "Name" = format("%s-%s-dhcp-opt", var.app_name, var.env)
    },
    local.tags,
...
resource "aws_internet_gateway" "this" {
  ...
  tags = merge(
    {
      "Name" = format("%s-%s-igw", var.app_name, var.env)
    },
    local.tags,
    var.igw_tags,
  )
...
resource "aws_egress_only_internet_gateway" "this" {
  ...
  tags = merge(
    {
      "Name" = format("%s-%s-ergress-igw", var.app_name, var.env)
    },
    local.tags,
    var.igw_tags,
  )
...
resource "aws_default_route_table" "default" {
  ...
  tags = merge(
    {
      "Name" = format("%s-%s-default-rt", var.app_name, var.env)
    },
    local.tags,
...
resource "aws_route_table" "public" {
  ...
  tags = merge(
    {
      "Name" = format("${var.public_subnet_suffix}-%s-%s-rt", var.app_name, var.env)
    },
    local.tags,
...
resource "aws_route_table" "private" {
  ...
  tags = merge(
    {
      "Name" = var.single_nat_gateway ? "${var.private_subnet_suffix}-${var.app_name}-${var.env}-rt" : format(
        "${var.private_subnet_suffix}-%s-%s-%s-rt",
        var.app_name,
        var.env,
...
resource "aws_route_table" "database" {
  ...
  tags = merge(
    {
      "Name" = var.single_nat_gateway || var.create_database_internet_gateway_route ? "${var.database_subnet_suffix}-${var.app_name}-${var.env}-rt" : format(
        "${var.database_subnet_suffix}-%s-%s-%s-rt", var.app_name, var.env, element(var.azs, count.index)
      )
    },
    local.tags,
...
resource "aws_subnet" "public" {
  ...
  tags = merge({
    "Name" = format(
      "${var.public_subnet_suffix}-%s-%s-subnet-%s",
      var.env,
      var.app_name,
      count.index + 1
    ) },
...
resource "aws_subnet" "private" {
  ...
  tags = merge({
    "Name" = format(
      "${var.private_subnet_suffix}-%s-%s-subnet-%s",
      var.env,
      var.app_name,
      count.index + 1
    ) },
...
resource "aws_subnet" "database" {
  ...
  tags = merge({
    "Name" = format(
      "${var.database_subnet_suffix}-%s-%s-subnet-%s",
      var.env,
      var.app_name,
      count.index + 1
    ) },
...
resource "aws_db_subnet_group" "database" {
  ...
  tags = merge(
    {
      "Name" = format("%s-%s-subnet-grp", var.app_name, var.env)
    },
    local.tags,
...
resource "aws_default_network_acl" "this" {
  ...
  tags = merge(
    {
      "Name" = format("%s-%s-%s-nacl", var.app_name, var.env, var.default_network_acl_name)
    },
    local.tags,
...
resource "aws_network_acl" "public" {
  ...
  tags = merge(
    {
      "Name" = format("${var.public_subnet_suffix}-%s-%s-nacl", var.app_name, var.env)
    },
    local.tags,
    var.public_acl_tags,
  )
...
resource "aws_network_acl" "private" {
  ...
  tags = merge(
    {
      "Name" = format("${var.private_subnet_suffix}-%s-%s-nacl", var.app_name, var.env)
    },
    local.tags,
...
resource "aws_network_acl" "database" {
  ...
  tags = merge(
    {
      "Name" = format("${var.database_subnet_suffix}-%s-%s-nacl", var.app_name, var.env)
    },
    local.tags,
...
resource "aws_default_vpc" "this" {
  ...
  tags = merge(
    {
      "Name" = format("%s-%s", var.default_vpc_name, var.env)
    },
    local.tags,
